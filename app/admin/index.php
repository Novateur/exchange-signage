                    ...
                    <div class="container">
                      <div class="row">
                        <?php
                          ...
                          {
                            echo "<div class='alert alert-success'><h3>Welcome back Admin</h3></div>";
                          }
                        ?>
                      </div>
                      <div class="row">
                          <a href="users.php"><div class="panel col-md-4">
  	                        <div class="padder" align="center">
  	                          <!--<img src="images/us.png"style="width: 180px;">-->
                              <div style='font-size:60px'><i class='ion-person-stalker'></i></div>
  	                            <span style="color: black;font-size: 20px">Users</span>
  	                        </div>
                          </div></a> 
                          ...
                          <a href="add_currencies.php"><div class="panel col-md-4">
  	                        <div class="padder" align="center">
                            <div style='font-size:60px'><i class='fa fa-money'></i></div>
  	                            <span style="color: black;font-size: 20px">Add currencies</span>
  	                        </div>
                          </div></a>
                          ...
                          <a href="view_banks.php"><div class="panel col-md-4">
                            <div class="padder" align="center">
                            <div style='font-size:60px'><i class='fa fa-home'></i></div>
                                <span style="color: black;font-size: 20px">Banks</span>
                            </div>
                          </div></a>
