...
<body class="" style="font-family: verdana">
                    ...
                    <div class="container">
                      <div class="row">
                          <div class="panel col-md-12" style="padding: 20px">
                            <div align="center" style="font-size: 28px">Available Banks</div>
                            <?php
                              get_banks();
                            ?>
                          </div>    
  ...
  <div class="modal-dialog" style='width:400px;margin-top:50px'>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class='ion-trash-b'></i> Delete Bank</h4>
      </div>
  ...
  <script>
      ...
      {
        $('#paste_proceed').html("<button type='button' class='btn btn-danger' onclick=\"cont_del_bank("+id+")\">Ok</button>");
        $('#delete_modal').modal('show');
      }

      function cont_del_bank(id)
      {
        $.post("handler/delete_bank.php",{id:id},function(response){
          if(response=="deleted")
          {
          ...
          {
            $('#paste_response').html("<div class='alert alert-danger'>Unable to delete bank</div>");
          }
        })
      }
  </script>
